            ...
            <div id="container">
                <div class="header fade">
                    <header class="header_tit">
                        <h1 class="logo">
                            <a href="mainpage" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span>
                            </a>
                            <a href="mainpage" class="lnk_logo" title="예약"> <span class="spr_bi ico_bk_logo">예약</span>
                            </a>
                        </h1>
                ...
                <div class="ct main">
                    <div>
                        <div class="section_visual">
                            <header>
                                <h1 class="logo">
                                    ...
                                    <a href="mainpage" class="lnk_logo" title="예약"> <span
                                            class="spr_bi ico_bk_logo">예약</span> </a>
                                </h1>
                                <a href="myreservation" class="btn_my"> <span class="viewReservation"
                            ...
                            <div class="pagination">
                                ...
                                <div class="figure_pagination">
                                    ...
                                    <span class="num off">/ <span>${detailImgCount}</span></span>
                                </div>
                            </div>
                            <div class="group_visual">
                                <div class="details">
                                    ...
                                    <c:if test="${detailImgCount > 1}">
                                        ...
                                        <div class="nxt">
                                            <div class="nxt_inn">
                                                <a href="#" onclick="nextImage()" class="btn_nxt" title="다음">
                            ...
                            <div class="group_btn_goto" style="display: none;">
                                <a class="btn_goto_home" title="홈페이지" href="#" target="siteUrl"> <i
                        ...
                        <div class="section_store_details">
                            ...
                            <a href="#" class="bk_more _open" onclick="unfold()"> <span class="bk_more_txt"
                                    id="unfold">펼쳐보기</span> <i class="fn fn-down2"></i> </a>
                            <a href="#" class="bk_more _close" style="display: none;" onclick="fold()"> <span
                                    class="bk_more_txt" id="fold">접기</span> <i class="fn fn-up2"></i> </a>
                        </div>
                        ...
                        <div class="section_review_list">
                            <div class="review_box">
                                ...
                                <div class="short_review_area">
                                    <div class="grade_area">
                                        ...
                                        <strong class="text_value"> <span>4.2</span> <em class="total">5.0</em>
                                        </strong>
                                        <span class="join_count"><em class="green">${commentCount}개</em> 등록</span>
                                    </div>
                            ...
                            <a class="btn_review_more" href="review?productId=${productId}"> <span>예매자 한줄평 더보기</span> <i
                        ...
                        <div class="section_info_tab">
                            ...
                            <ul class="info_tab_lst">
                                <li class="item active _detail">
                                    <a href="#" class="anchor active" onclick="showDetail()"> <span>상세정보</span> </a>
                                </li>
                                <li class="item _path">
                                    <a href="#" class="anchor" onclick="showMap()"> <span>오시는길</span> </a>
                                </li>
                            </ul>
                                ...
                                <div class="box_store_info no_topline">
                                    <a href="#" class="store_location" title="지도웹으로 연결">
                                        <img class="store_map img_thumb" alt="map"
                                            src="${productDetailsForMap[0].save_file_name}">
                                        <span class="img_border"></span>
                                        <span class="btn_map"><i class="spr_book2 ico_mapview"></i></span>
                                    </a>
                                    <h3 class="store_name">${productDetailsForMap[0].description}</h3>
                                    <div class="store_info">
                                        <div class="store_addr_wrap">
                                            <span class="fn fn-pin2"></span>
                                            <p class="store_addr store_addr_bold">${productDetailsForMap[0].place_street} </p>
                                            <p class="store_addr">
                                                <span class="addr_old">지번</span>
                                                <span class="addr_old_detail">${productDetailsForMap[0].place_lot} </span>
                                            </p>
                                            <p class="store_addr addr_detail">${productDetailsForMap[0].place_name}</p>
                                        </div>
                                        <div class="lst_store_info_wrap">
                                            <ul class="lst_store_info">
                                                <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i>
                                                        <span class="sr_only">전화번호</span> </span> <span class="item_rt">
                                                        <a href="tel:02-548-0597"
                                                            class="store_tel">${productDetailsForMap[0].tel}</a></span> </li>
                                            </ul>
                                        </div>
                                    </div>
