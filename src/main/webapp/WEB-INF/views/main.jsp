            ...
            <div id="container">
                <div class="header">
                    <header class="header_tit">
                        <h1 class="logo">
                            ...
                            <a href="./myreservation.html" class="lnk_logo" title="예약"> <span
                                    class="spr_bi ico_bk_logo">예약</span> </a>
                        </h1>
                        <a href="./bookinglogin.html" class="btn_my"> <span class="viewReservation"
                ...
                <div class="event">
                                ...
                                <div class="prev_e" style="display:none;">
                                    <div class="prev_inn">
                                        <a href="#" class="btn_pre_e" title="이전"> <i
                                                class="spr_book_event spr_event_pre">이전</i> </a>
                                    </div>
                                </div>
                                <div class="nxt_e" style="display:none;">
                                    <div class="nxt_inn">
                                        <a href="#" class="btn_nxt_e" title="다음"> <i
                                                class="spr_book_event spr_event_nxt">다음</i> </a>
                                    </div>
                                </div>
                                <div>
                                    <div class="container_visual">
                                        ...
                                        <!-- 블로그 HTML Template 맨 마지막 부분 참고 -->
                                        <script id="template-promotion" type="text/template">
                                                <img src="{promotionImgPath}" width='414px' height='210px'>
                                         </script>
                    ...
                    <div class="section_event_tab">
                        <ul class="event_tab_lst tab_lst_min">
                            <li class="item" data-category="0">
                                <a class="anchor" id="all" onclick="show(this.id)"> <span>전체리스트</span> </a>
                            </li>
                    ...
                    <div class="section_event_lst">
                        <p class="event_lst_txt">바로 예매 가능한 행사가 <span class="pink">${productAllCount}개</span> 있습니다</p>
                        <div class="wrap_event_box">
                            <!-- [D] lst_event_box 가 2컬럼으로 좌우로 나뉨, 더보기를 클릭할때마다 좌우 ul에 li가 추가됨 -->
                            <ul class="lst_event_box" id="firstItem">
                            ...
                            <ul class="lst_event_box" id="secondItem">

                            </ul>
                            <!-- 더보기 -->
                            <div class="more">
                                <button class="btn" onclick="moreProducts()"><span>더보기</span></button>&nbsp; &nbsp;
                            </div>
